...
const API_KEY =
  "live_fPKVIcO1xJs1E98UXh94BrLsolj0lxXJVgQZsb9DJdLJ7bwip4QUZCGNOWfLGWs4";
...
axios.interceptors.response.use(
  (response) => {
    ...
    if (start) {
      ...
      console.log(`Response to ${response.config.url} took ${ms} ms`);
    } else {
...
// TODO:Create a default selection in Breedselect
...
breedSelect.addEventListener("change", async (e) => {
  ...
  //   `https://api.thecatapi.com/v1/images/search?limit=100&breed_ids=${breedId}&api_key=${API_KEY}`
  // );
  ...
  const selectBreed = await axios({
    method: "get",
    url: `https://api.thecatapi.com/v1/images/search?limit=100&breed_ids=${breedId}&api_key=${API_KEY}`,
  });
